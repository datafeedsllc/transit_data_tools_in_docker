...
<html lang="en">
<head>
    <title>Code coverage report for src/message.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> message.js
    </h1>
    <div class='clearfix'>
...
import get from 'lodash/get'<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ><span class="missing-if-branch" title="else path not taken" >E</span><span class="branch-0 cbranch-no" title="branch not covered" ></span></span></span></span>
&nbsp;
...
&nbsp;
let messages = {}
<span class="missing-if-branch" title="else path not taken" >E</span>if (process.env.MESSAGES) {
...
function replaceMessage (msg, data) {
  return msg.replace(
    ...
    (m, key) =&gt; data.hasOwnProperty(key) ? data[key] : m<span class="branch-1 cbranch-no" title="branch not covered" ></span>
  )
}
&nbsp;</pre></td></tr>
</table></pre>
