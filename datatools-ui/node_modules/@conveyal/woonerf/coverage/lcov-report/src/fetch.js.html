...
<html lang="en">
<head>
    <title>Code coverage report for src/fetch.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> fetch.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.63% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>250/267</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.09% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>111/132</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L344'></a><a href='#L344'>344</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">7x</span>
...
import isObject from 'lodash/isObject'<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="missing-if-branch" title="if path not taken" >I</span><span class="missing-if-branch" title="else path not taken" >E</span><span class="branch-2 cbranch-no" title="branch not covered" ><span class="branch-1 cbranch-no" title="branch not covered" ><span class="missing-if-branch" title="else path not taken" >E</span><span class="branch-1 cbranch-no" title="branch not covered" ><span class="missing-if-branch" title="else path not taken" >E</span><span class="missing-if-branch" title="else path not taken" >E</span><span class="branch-0 cbranch-no" title="branch not covered" ></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span></span>
...
export const abortAllFetches = () =&gt;
  Object.keys(activeFetches).reduce((aborts, fetchType) =&gt; {
    if (fetchType === GFT) {
      return [
        ...aborts,
        ...activeFetches[GFT].m<span class="fstat-no" title="function not covered" >ap</span>(id =&gt; abortF<span class="cstat-no" title="statement not covered" >etch({type: GFT, id}))</span>
      ]
    } else {
      return [
        ...aborts,
...
&nbsp;
  return fetch(url, {
    ...
    .then(createResponse)
    .then(async (response) =&gt;
      (retry &amp;&amp; isActive(signature) &amp;&amp; await retry(response))<span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span></span>
        ? runFetch({signature, options, retry, url}, state)<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ></span></span>
        : response)<span class="branch-5 cbranch-no" title="branch not covered" ></span>
}
&nbsp;
/**
...
function runFetchMultiple ({
  ...
  fetches,
  next
}, state) {<span class="branch-1 cbranch-no" title="branch not covered" ></span>
  const signature = {type, id}
  const dispatchFetchError = !next || next.length &lt; 2
  const wrappedNext = wrapNext(next)
&nbsp;
    ...
    Promise.all(fetches.map((fetch) =&gt; runFetch({...fetch, signature}, state)))
      ...
      .catch((error) =&gt;
        createErrorResponse(error)
          .then((response) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>    if (isActive(signature)) {
              const actions = [
                decrementFetches(signature),
                wrappedNext(error, response)
              ]
...
function createAuthorizationHeader (state) {
  return state.user &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >state.user.idToken</span>
<span class="branch-0 cbranch-no" title="branch not covered" >    ? {Authorization: `bearer ${state.user.idToken}`}</span>
    : {}
}
&nbsp;
...
function createResponse (res) {
  return deserialize(res)
    ...
    .cat<span class="fstat-no" title="function not covered" >ch</span>((err) =&gt; {
<span class="cstat-no" title="statement not covered" >      res.value = err</span>
...
async function deserialize (res) {
  ...
  if (header.indexOf('json') &gt; -1) return res.json()<span class="missing-if-branch" title="else path not taken" >E</span>
  if (header.indexOf('octet-stream') &gt; -1) return res.arrayBuffer()<span class="cstat-no" title="statement not covered" ></span>
