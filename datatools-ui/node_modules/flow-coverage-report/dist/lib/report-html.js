...
function generateFlowCoverageReportHTML(coverageSummaryData, opts) {
  ...
  var generateSummary = renderHTMLReport({
    ...
    coverageGeneratedAt: coverageGeneratedAt, projectDir: projectDir, data: coverageSummaryData, outputDir: outputDir
  });
  ...
  var generateSourceFiles = Object.keys(coverageSummaryData.files).map(function (filename) {
    ...
    return renderHTMLReport({
      type: 'sourcefile', coverageGeneratedAt: coverageGeneratedAt,
      htmlTemplateOptions: opts.htmlTemplateOptions,
      projectDir: projectDir, filename: filename, data: data, outputDir: outputDir
    });
  });
