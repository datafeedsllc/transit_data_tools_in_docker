...
exports.defaultConfig = exports.UsageError = undefined;
...
var getProjectDir = function getProjectDir(config) {
  return (0, _extends3.default)({}, defaultConfig, config).projectDir;
};
...
function loadConfig(args) {
  ...
  if (args.config) {
    ...
    var fileConfigData = (0, _parseJson2.default)((0, _stripJsonComments2.default)('' + fileRawData));

    if (process.env.VERBOSE) {
      console.log('Loaded config from file', filePath, fileConfigData);
    }

    return (0, _extends3.default)({}, defaultConfig, fileConfigData, args);
  }
  ...
  try {
    ...
    if (pkg['flow-coverage-report']) {
      ...
      return (0, _extends3.default)({}, defaultConfig, pkg['flow-coverage-report'], args);
    }
  } catch (err) {
    if (process.env.VERBOSE) {
  ...
  try {
    ...
    var projectConfigData = (0, _parseJson2.default)((0, _stripJsonComments2.default)('' + projectConfigRaw));

    if (process.env.VERBOSE) {
      console.log('Loaded config from project dir', projectConfigPath, projectConfigData);
    }

    return (0, _extends3.default)({}, defaultConfig, projectConfigData, args);
  } catch (err) {
    if (process.env.VERBOSE) {
...
function validateConfig(args) {
  ...
  var includeGlob = args.includeGlob;
  ...
  try {
    for (var _iterator3 = includeGlob[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
