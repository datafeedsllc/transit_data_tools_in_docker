...
module.exports = {
  processArgv: function processArgv(argv) {
    var appName = _path2.default.basename(argv[1]).split('.')[0];

    return (0, _yargs2.default)(argv).usage('Usage: $0 COMMAND PROJECTDIR [...globs]').command('report', 'Generate Flow Coverage Report on file selected by the GLOB parameter').help('h').alias('h', 'help').version(function () {
