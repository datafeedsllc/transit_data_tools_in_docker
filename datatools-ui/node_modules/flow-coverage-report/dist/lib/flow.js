...
var checkFlowStatus = function () {
  var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(flowCommandPath, projectDir, tmpDirPath) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (process.env.VERBOSE && process.env.VERBOSE === 'DUMP_JSON') {
              tmpFilePath = _temp2.default.path({ suffix: '.json', dir: tmpDirPath });
            }
  ...
  return function checkFlowStatus(_x, _x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

var collectFlowCoverageForFile = function () {
  var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(flowCommandPath, flowCommandTimeout, projectDir, filename, tmpDirPath) {
    var tmpFilePath, emptyCoverageData, res, parsedData, flowCoverageParsingError;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return (0, _promisified.exec)(flowCommandPath + ' coverage --json ' + filename,
  ...
  return function collectFlowCoverageForFile(_x4, _x5, _x6, _x7, _x8) {
...
exports.collectFlowCoverage = function (flowCommandPath, flowCommandTimeout, projectDir, globIncludePatterns, globExcludePatterns, threshold, concurrentFiles, tmpDirPath) {
  return checkFlowStatus(flowCommandPath, projectDir, tmpDirPath).then(function (flowStatus) {
    ...
    function collectCoverageAndGenerateReportForGlob(globIncludePattern) {
      ...
      return (0, _promisified.glob)(globIncludePattern, { cwd: projectDir, root: projectDir }).then(function () {
        var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(files) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            if (!(globExcludePatterns.find(function (pattern) {
                          ...
                          case 4:
                            ...
                            waitForCollectedDataFromFiles.push(collectFlowCoverageForFile(flowCommandPath, flowCommandTimeout, projectDir, filename, tmpDirPath).then(function (data) {
                              /* eslint-disable camelcase */
