...
module.exports = function HTMLReportBodySourceFile(props) {
  ...
  var percent = coverageData.percent || NaN;
  ...
  if (props.htmlTemplateOptions && props.htmlTemplateOptions.showMeterBar) {
    meterBar = _react2.default.createElement(_coverageMeterBar2.default, { percent: percent, threshold: props.threshold });
  }
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('textarea', { id: 'file-content', value: String(fileContent), readOnly: true })
        )
      ),
      _react2.default.createElement(
        'div',
