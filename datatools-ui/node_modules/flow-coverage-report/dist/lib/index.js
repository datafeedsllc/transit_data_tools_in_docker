...
var generateFlowCoverageReport = function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt('return', Promise.reject(new Error('projectDir option is mandatory')));
          ...
          case 16:
            ...
            return _context.abrupt('return', Promise.reject(new Error('empty globIncludePatterns option')));
          ...
          case 18:
            ...
            return _context.abrupt('return', Promise.reject(new Error('threshold option is mandatory')));

          case 20:
            _context.next = 22;
            return (0, _flow.collectFlowCoverage)(opts.flowCommandPath, opts.flowCommandTimeout, opts.projectDir, opts.globIncludePatterns, opts.globExcludePatterns, opts.threshold, opts.concurrentFiles || 1, tmpDirPath);
  ...
  return function generateFlowCoverageReport(_x) {
...
var DEFAULT_FLOW_TIMEOUT = 15 * 1000;
